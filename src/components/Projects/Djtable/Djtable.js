        ...
        <Row md={12}>
          <Col md={6}>
            <Col md={12}>
              ...
              <p>
                ...
                consist of two parts: a) Each physical object on the table has
                its visual effects. A dial circle is shown that represents four
                different tracks of an instrument. At a specific distance
                between two or several objects, an exploding effect is shown
                which represents the fifth track. b) A standalone space-themed
                visual experience is presented for the audience. The visual
                integrates with the music and creates a pleasing visual
                experience.
              </p>
          ...
          <Col md={6}>
            <Col md={12}>
              <h4> My role </h4>
              <p>
                I had my focus on modeling the 3D physical objects
                (representative of each instrument) using Blender. The models
                were then printed out using Ultimaker Cura. Later on, I engaged
                myself in creating particle systems in Unity and implementing
                distance-based effects. The distance-based effects mean when two
                physical objects come close to each other, a new particle system
                gets triggered. Additionally, I developed a project website and
