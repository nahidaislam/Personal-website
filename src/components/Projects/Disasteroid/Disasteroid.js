        ...
        <Row md={12}>
          <Col md={6}>
            <Col md={12}>
              <h4>Interaction</h4>
              <p>
                Disasteroid is supported on Android 7.0 'Nougat' (API Level 24)
              ...
              <p>
                ...
                information about the population density. The player can then
                try to deflect the asteroids in a less dense area.
              </p>
          ...
          <Col md={6}>
            <Col md={12}>
              ...
              <p>
                ...
                Blender. I was responsible for the 3D printing and decorating
                the special weapon, i.e. the satellite. I was also the project
                leader and was responsible for building the project website.
              </p>
